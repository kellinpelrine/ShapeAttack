function returntest = model(gamma,epsilon,alpha,rho,sigmaerror,mu,IYssratio,KYssratio,nss,kss,delta,beta,b,xgrid,ugrid)
...
for i=1:Nkap
    for j=1:Nkap
        for m=1:M
            ...
            C=max(cons,.0001);
            Utility=u2(C,labor,gamma,b,epsilon,xgrid,ugrid);
